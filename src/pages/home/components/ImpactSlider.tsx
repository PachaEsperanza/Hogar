...
const impactCards: ImpactCard[] = [
  {
    icon: 'ri-group-line',
    image: '/Hogar/images/impact1.jpeg',
  ...
  },
  {
    ...
    image: '/Hogar/images/impact3.jpeg',
...
const voices = [
  ...
  },
  {
    ...
    image: '/Hogar/images/farmer5.jpg',
    years: 8,
  ...
  return (
    <section className="relative py-10 md:py-14 px-4 md:px-6 overflow-hidden">
      <div className="absolute inset-0" style={{zIndex:0}}>
        <img src="/Hogar/images/process3.jpeg" alt="" className="w-full h-full object-cover object-center" />
